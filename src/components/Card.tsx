...
const Card = ({ period, title, description, skills, imageUrl }: CardProps) => {
  return (
    <div className="flex gap-2 md:gap-12 lg:gap-16 flex-col md:flex-row w-full text-zinc-400 rounded-md p-5 cursor-pointer hover:[&_h3]:text-blue-400 shadow-lg shadow-sky-300/10 transition-all hover:shadow-md hover:shadow-sky-300/65 duration-150 ease-in">
